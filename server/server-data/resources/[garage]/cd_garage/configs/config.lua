...
Config.Language = 'ES' --[ 'EN' / 'CZ' / 'DE' / 'DK' / 'ES' / 'FI' / 'FR' / 'NO' / 'NL' / 'PT' / 'SE' / 'SK' ]   You can add your own locales to locales.lua, but be sure to update the Config.Language to match it.
...
Config.Impound = {
    ...
    chat_command = 'confiscar', --Customise the chat command to impound vehicles.
...
Config.JobVehicles = {
    ...
    Locations = {
        ...
        ['ambulance'] = {
            --PILLBOX HOSPITAL
            [1] = {coords = vector3(-453.617, -332.339, 34.367), spawn_coords = vector4(-453.617, -332.339, 34.367, 82.921165466309), distance = 10, garage_type = 'car', method = 'regular'}, --Pillbox Hospital (cars)
        ...
        ['mechanic'] = {
            --lscustom
            [1] = {coords = vector3(-360.428, -119.439, 38.698), spawn_coords = vector4(-363.343, -118.723, 38.698, 62.764614105225), distance = 10, garage_type = 'car', method = 'regular'},
        },
    },
    ...
    RegularMethod = {
        ...
        ['police'] = {
            [1] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `police2`},
            [2] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `police3`},
            [3] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `riot`},
            [4] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `police`},
            [5] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `dodgesamu`},
            [6] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `policet`},
            [6] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `policeinsurgent`},
            [6] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `ghispo2`},
            [7] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `brickade`},

            [8] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'air', model = `polmav`},

            [9] = {job = 'police', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'boat', model = `predator`},
        },
        ['ambulance'] = {
            [1] = {job = 'ambulance', spawn_max = true, plate = 'EMS', job_grade = 0, garage_type = 'car', model = `emsnspeedo`},
            [2] = {job = 'ambulance', spawn_max = true, plate = 'EMS', job_grade = 0, garage_type = 'air', model = `polmav`},
        },
        ['mechanic'] = {
            [1] = {job = 'mechanic', spawn_max = true, plate = 'MECHANIC', job_grade = 0, garage_type = 'car', model = `flatbedm2`},
        },
    }
}
...
Config.ImpoundLocations = { --DO NOT CHANGE THE TABLE IDENTIFIERSs, for example - ['car_2'], if you wish to add more, then name the next one ['car_3']. It must have either 'car'/'boat'/'air' in the name and also be unique.
    ['car_1'] = {
        ...
        coords = {x = -379.256, y = -105.606, z = 38.698}, --This is the location of the garage, where you press e to open for example.
        spawnpoint = {x = -374.635, y = -106.46, z = 38.684, h = 159.80908203125}, --This is the location where the vehicle spawns. 
        blip = {
            sprite = 357, --Icon of the blip. -
    ...
    ['car_2'] = { 
        ImpoundID = 2,
        coords = {x = 476.898, y = -1022.108, z = 28.048}, 
        spawnpoint = {x = 477.26, y = -1023.083, z = 28.054, h = 273.36386108398},
        blip = {
            sprite = 357,
            scale = 0.5,
            colour = 9,
