return {
	...
	Ammunation = {
		...
		blip = {
			...
			{ name = 'WEAPON_PISTOL', price = 25000, metadata = { registered = true } },
	...
	PoliceArmoury = {
		...
		blip = {
			...
			{ name = 'WEAPON_MICROSMG', price = 0, metadata = { registered = true, serial = 'POL' } },
			{ name = 'WEAPON_ASSAULTRIFLE', price = 0, metadata = { registered = true, serial = 'POL' } },
			{ name = 'WEAPON_CARBINERIFLE', price = 0, metadata = { registered = true, serial = 'POL' }, grade = 0 },
			{ name = 'WEAPON_STUNGUN', price = 0, metadata = { registered = true, serial = 'POL'} }
		}, locations = {
			vec3(482.609, -995.445, 30.69)
		}, targets = {
	...
	BlackMarketArms = {
		...
		inventory = {
			...
			{ name = 'WEAPON_ASSAULTRIFLE', price = 180000, metadata = { registered = false }, currency = 'black_money' },
			{ name = 'WEAPON_MICROSMG', price = 120000, metadata = { registered = false }, currency = 'black_money' },
			{ name = 'WEAPON_CARBINERIFLE', price = 250000, metadata = { registered = false }, currency = 'black_money' },
			{ name = 'WEAPON_HEAVYSNIPER', price = 1000000, metadata = { registered = false }, currency = 'black_money' },
			{ name = 'WEAPON_MUSKET', price = 750000, metadata = { registered = false }, currency = 'black_money' },
			{ name = 'ammo-9', price = 1000, currency = 'black_money' }
		}, locations = {
			vec3(4924.669, -5244.087, 2.523)
		}, targets = {
