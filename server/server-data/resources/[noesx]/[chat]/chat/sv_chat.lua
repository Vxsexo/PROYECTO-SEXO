...
AddEventHandler('playerJoining', function()
    ...
    -- TriggerClientEvent('chatMessage', -1, '', { 255, 255, 255 }, '^2* ' .. GetPlayerName(source) .. ' se desperto.')
end)
...
AddEventHandler('playerDropped', function(reason)
    ...
    -- TriggerClientEvent('chatMessage', -1, '', { 255, 255, 255 }, '^2* ' .. GetPlayerName(source) ..' se fue a dormir por (' .. reason .. ')')
    -- TriggerClientEvent('chatMessage', -1, '', { 255, 255, 255 }, '^8* ' .. GetPlayerName(source) ..' se fue a dormir.')
end)
