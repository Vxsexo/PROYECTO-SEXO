...
function takeHostage()
	...
	if not canTakeHostage then 
		drawNativeNotification("¡Necesitas una pistola con munición para tomar un rehén a punta de pistola!")
	end
...
Citizen.CreateThread(function()
	while true do 
		if holdingHostage then
			...
			DrawText3D(playerCoords.x,playerCoords.y,playerCoords.z,"Presiona [G] para liberar, [H] para matar")
