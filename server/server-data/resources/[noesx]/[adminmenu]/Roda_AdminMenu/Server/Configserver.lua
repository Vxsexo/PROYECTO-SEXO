...
ConfigServer.esx_advancedgarage = false --This only if u use esx_advancedgarage.
 ConfigServer.LanguageSv = {
     ...
     kickreason = "Has sido kickeado por la siguiente Razon: ",
...
ConfigServer.PhotoUrl = ''
ConfigServer.WebHookForPhotos = 'https://discord.com/api/webhooks/1208107052300509205/5ChdSzTrGFePOvkNVwlR79L8upq8KU-NAlpMkdQGed4yytRQdshcZQ4xp4STCw2-J-Cz'
ConfigServer.Webhooks = {
    ["adminlogs"] = "https://discord.com/api/webhooks/1208107052300509205/5ChdSzTrGFePOvkNVwlR79L8upq8KU-NAlpMkdQGed4yytRQdshcZQ4xp4STCw2-J-Cz"
}

ConfigServer.UsernameForWebhook = 'Roda-Admin Menu'
