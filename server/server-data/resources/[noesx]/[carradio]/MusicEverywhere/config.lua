...
Config.Zones = {
	{
		...
		coords = vector3(-307.518, -102.365, 39.016), -- the position where the music is played
		...
		changemusicblip = vector3(-307.518, -102.365, 39.016) -- where the player can change the music
	},
	{
		name = "Vanilla Zone", -- The name of the radio, it doesn't matter
		coords = vector3(120.949, -1281.275, 29.481), -- the position where the music is played
		...
		deftime = 0, -- where does the music starts? 0 and it will start in the beginning
		changemusicblip = vector3(120.949, -1281.275, 29.481) -- where the player can change the music
	},
	{
		name = "BurguerKing Zone", -- The name of the radio, it doesn't matter
		coords = vector3(-1198.903, -892.752, 13.886), -- the position where the music is played
		job = "burguerking", --the job that can change the music
		range = 30.0, -- the range that music can be heard
		volume = 0.1, --default volume? min 0.00, max 1.00
		deflink = "https://www.youtube.com/watch?v=W9iUh23Xrsg",-- the default link, if nill it won't play nothing
		isplaying = false, -- the music will play when the server start?
		loop = false,-- when the music stops it will repaeat?
		deftime = 0, -- where does the music starts? 0 and it will start in the beginning
		changemusicblip = vector3(-1198.903, -892.752, 13.886) -- where the player can change the music
	},
}