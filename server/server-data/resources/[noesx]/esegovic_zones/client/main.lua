...
AddEventHandler(
    ...
    function(k, o)  
        ...
        SetBlipColour(blip1, 62)
        SetBlipAsShortRange(ay, true)
        BeginTextCommandSetBlipName("STRING")
        AddTextComponentString("~y~*~r~" .. FirstLetterUpperCase(o) .. "~y~*~s~ - Zona Libre")
...
AddEventHandler(
    ...
    function(k, o, p)
        xd123 = AddBlipForRadius(k, 140.0)
