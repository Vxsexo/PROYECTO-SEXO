...
Strings = {
    ['press_start'] = 'Presione ~INPUT_PICKUP~ para coger una bola',
    ['next_last_select'] = '~INPUT_CELLPHONE_RIGHT~ ~INPUT_CELLPHONE_LEFT~ Cambiar de carril\n~INPUT_FRONTEND_ENDSCREEN_ACCEPT~ Seleccione\n~INPUT_FRONTEND_RRIGHT~ Cancelar',
    ['bowling_info'] = '~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_RIGHT~ Direccion\n~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ Fuerza \n~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ Cambiar cámara\n~INPUT_ATTACK~ At\n~INPUT_FRONTEND_RRIGHT~ Cancelar',
    ['force'] = 'Fuerza: %s',
    ['strike'] = {'¡GUAU! ¡COMO Un MARTILLO!', '¡¡MARAVILLOSO!!'},
    ['spare'] = {'Semi Pleno', '¡Buen juego!'},
    ['x_pinsdown'] = {'Bolera', 'Nada mal %s hiciste %s en este juego'},
    ['this_occupied'] = 'Esta bolera está llena.',
    ['every_occupied'] = 'Estamos completamente llenos.',
    ['blip'] = 'Bolera'
}