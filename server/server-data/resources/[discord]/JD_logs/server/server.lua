...
AddEventHandler("playerConnecting", function(name, setReason, deferrals)
	SinglePlayerLogs('**' ..GetPlayerName(source).. '** se está conectando al servidor.', Config.BaseColors['joins'], source, 'joins')
end)

-- Send message when Player disconnects from the server
AddEventHandler('playerDropped', function(reason)
	SinglePlayerLogs('**' ..GetPlayerName(source).. '** ha abandonado el servidor. (Reason: ' .. reason .. ')', Config.BaseColors['leaving'], source, 'leaving')
end)
...
AddEventHandler('playerShotWeapon', function(weapon)
	...
	if Config.weaponLog then
		SinglePlayerLogs('**' .. GetPlayerName(source)  .. '** disparó con `' .. weapon .. '`', Config.BaseColors['shooting'], source, 'shooting')
    end
end)
