    ...
    while true do
        ...
        for i = 1, #Config.Doctor, 1 do
            ...
            if userDst <= 15 then
                sleep = 2
                if userDst <= 5 then
                    DrawText3D(konum.x, konum.y, konum.z, 'Pulsa [E] para ser tratado $'.. Config.doctorPrice)
                                ...
                                if canEms == true then
                                    ...
                                    ESX.TriggerServerCallback('draco-custom:parakontrol', function(hasEnoughMoney) --draco
                                        if hasEnoughMoney then
                                            ...
                                            exports['mythic_notify']:DoHudText('error', 'No necesitas asistencia medica!') --draco
                                        end
                                    end)
