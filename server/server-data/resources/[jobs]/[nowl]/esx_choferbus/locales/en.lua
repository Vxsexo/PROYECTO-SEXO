Locales['en'] = {
    ['route_assigned']                      = 'Te han asignado una ruta %s.',
    ['drive_to_first_marker']               = 'Tome el autobús y maneje hasta la primera parada en %s.',
    ['drive_to_next_marker']                = 'Continúa hasta la próxima parada en %s.',
    ['no_passengers_loading_or_unloading']  = 'No hay pasajeros en esta parada',
    ['no_passengers_unloading']             = 'Espera a que las pasajeros terminen de subirse',
    ['no_passengers_loading']               = 'Espere a que los pasajeros terminen de bajarse. No hay pasajeros en esta parada',
    ['wait_for_passengers']                 = 'Espere a que los pasajeros terminen de subirse y bajarse.',

    ['route_selection_cancel']              = 'Selección de ruta de autobús cancelada.',
    ['route_selection_title']               = 'Selecciona la %s linea',
    ['route_selection_random']              = 'Aleatorio',

    ['start_route']                         = 'Presiona   ~INPUT_PICKUP~para comenzar %s.',
    ['passengers_loaded']                   = '%d Los pasajeros pagaron por esta parada. Ganaste $%d.',
    ['return_to_terminal']                  = 'La ruta está terminada. Regresa al terminal.',
    ['stop_bus']                            = 'Pare el autobús para devolverlo y que le paguen.',
    ['abort_route_help']                    = 'Presiona   ~INPUT_PICKUP~para abortar la ruta. Costará $%d.',
    ['get_back_in_bus']                     = 'Sube al autobús para continuar la ruta..',

    ['next_stop_label']                     = 'Proxima parada',
    ['money_earned_label']                  = 'Dinero ganado',
    ['stops_remaining_label']               = 'Paradas restantes',

    ['exploit_attempted_kick_message']      = 'Fuera, por hacer trampa!',
    ['exploit_attempted_log_message']       = 'Blarglebus: %s intento de explotación! (rason: llamadas del servidor cuando el trabajo no está configurado en busdriver)',
