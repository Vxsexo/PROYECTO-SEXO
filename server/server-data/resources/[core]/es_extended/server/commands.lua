ESX.RegisterCommand('setcoords', {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('setjob', {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand({'cardel', 'dv'}, {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('setaccountmoney', {'admin', 'superadmin'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('giveaccountmoney', {'admin', 'superadmin'}, function(xPlayer, args, showError)
	if args.playerId.getAccount(args.account) then
...
if not Config.OxInventory and not Config.QSInventory then
	ESX.RegisterCommand('giveitem', {'admin', 'superadmin'}, function(xPlayer, args, showError)
	...
	ESX.RegisterCommand('giveweapon', {'admin', 'superadmin'}, function(xPlayer, args, showError)
	...
	ESX.RegisterCommand('giveweaponcomponent', {'admin', 'superadmin'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand({'clearall', 'clsall'}, {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
	TriggerClientEvent('chat:clear', -1)
end, true, {help = _U('command_clearall')})

ESX.RegisterCommand("refreshjobs", {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
	ESX.RefreshJobs()
end, true, {help = _U('command_clearall')})

if not Config.OxInventory and not Config.QSInventory then
	ESX.RegisterCommand('clearinventory', {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
	...
	ESX.RegisterCommand('clearloadout', {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('save', {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('saveall', {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
	Core.SavePlayers()
end, true, {help = _U('command_saveall')})

ESX.RegisterCommand('group', {'user','mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
	print(xPlayer.getName()..", You are currently: ^5".. xPlayer.getGroup() .. "^0")
end, true)

ESX.RegisterCommand('job', {'user', 'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
	print(xPlayer.getName()..", You are currently: ^5".. xPlayer.getJob().name.. "^0 - ^5".. xPlayer.getJob().grade_label .. "^0")
end, true)

ESX.RegisterCommand('info', {'user', 'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
	local job = xPlayer.getJob().name
	local jobgrade = xPlayer.getJob().grade_name
	print("^2ID : ^5"..xPlayer.source.." ^0| ^2Name:^5"..xPlayer.getName().." ^0 | ^2Group:^5"..xPlayer.getGroup().."^0 | ^2Job:^5".. job.."^0")
end, true)

ESX.RegisterCommand('coords', {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('tpm', {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
	xPlayer.triggerEvent("esx:tpm")
end, true)

ESX.RegisterCommand('goto', {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('bring',{'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('kill', {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
	args.playerId.triggerEvent("esx:killPlayer")
end, true, {help = _U('command_kill'), validate = true, arguments = {
	{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand('freeze', {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
	args.playerId.triggerEvent('esx:freezePlayer', "freeze")
end, true, {help = _U('command_freeze'), validate = true, arguments = {
	{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand('unfreeze', {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
	args.playerId.triggerEvent('esx:freezePlayer', "unfreeze")
end, true, {help = _U('command_unfreeze'), validate = true, arguments = {
	{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand("noclip", {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
	xPlayer.triggerEvent('esx:noclip')
end, false)

ESX.RegisterCommand('players', {'mod', 'admin', 'superadmin'}, function(xPlayer, args, showError)
