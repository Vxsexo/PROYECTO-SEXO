...
Config.MaxWeight            	= 50000   -- the max inventory weight without backpack
Config.PaycheckInterval         = 7 * 180000 -- how often to recieve pay ch	ecks in milliseconds
...
Config.CustomAIPlates = 'ADMINCAR' -- Custom plates for AI vehicles 
