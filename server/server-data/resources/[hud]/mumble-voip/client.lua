...
RegisterNetEvent("mumble:instanceVoice")
AddEventHandler("mumble:instanceVoice", function()
	SetVoiceData("mode", 4)
end)

RegisterNetEvent("mumble:exitInstanceVoice")
AddEventHandler("mumble:exitInstanceVoice", function()
	SetVoiceData("mode", 2)
end)
