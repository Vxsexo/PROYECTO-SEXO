...
TriggerEvent('chat:addSuggestion', '/report', 'Escribe el reporte.', {
    { name="Titulo", help="Nombre del reporte" },
    { name="Mensaje", help="Escribe el problema" }
})

TriggerEvent('chat:addSuggestion', '/reportes', 'Mirar reportes pendientes.')
